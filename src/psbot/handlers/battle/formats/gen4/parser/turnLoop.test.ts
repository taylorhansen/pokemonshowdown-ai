...
import { initParser, ParserHelpers, toDetails, toEffectName, toHPStatus,
    toID, toIdent, toMoveName, toNum, toRequestJSON, toUsername } from
    "./helpers.test";
...
export const test = () => describe("turnLoop", function()
{
    ...
    beforeEach("Initialize turnLoop BattleParser", async function()
    {
