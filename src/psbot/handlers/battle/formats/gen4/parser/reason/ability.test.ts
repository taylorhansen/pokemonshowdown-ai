...
export const test = () =>
    describe("ability", function () {
        ...
        for (const [name, can] of [["isCopyable", true]] as const) {
            describe(`${name}()`, function () {
                describe("#canHold()", function () {
                    it(`Should return ${can} if having a copyable ability is the only possibility`, function () {
                        const mon = sh.initActive("p1");
                        mon.setAbility("illuminate");
                    ...
                    it("Should return null if possible to have or not have a copyable ability", function () {
                        const mon = sh.initActive("p1");
                        mon.setAbility("illuminate", "multitype");

                        const reason = reasonAbility[name](mon);
                        expect(reason.canHold()).to.be.null;
                    });

                    it(`Should return ${!can} if not possible to have a copyable ability`, function () {
                        const mon = sh.initActive("p1");
                ...
                describe("#assert()", function () {
                    ...
                    it("Should throw if overnarrowing", function () {
                        const mon = sh.initActive("p1");
                        mon.setAbility(can ? "multitype" : "illuminate");
                ...
                describe("#reject()", function () {
                    ...
                    it("Should throw if overnarrowing", function () {
                        const mon = sh.initActive("p1");
                        mon.setAbility(can ? "illuminate" : "multitype");
        ...
        describe("uncopyable()", function () {
            it("Should get un-copyable abilities", function () {
                const mon = sh.initActive("p1");
                mon.setAbility("illuminate", "multitype");

                expect(reasonAbility.uncopyable(mon)).to.have.keys("multitype");
            });

            it("Should return empty set if no un-copyable abilities", function () {
                const mon = sh.initActive("p1");
                mon.setAbility("illuminate");

                expect(reasonAbility.uncopyable(mon)).to.be.empty;
            });
        });
    });
