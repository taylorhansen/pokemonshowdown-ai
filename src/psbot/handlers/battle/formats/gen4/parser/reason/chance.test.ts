...
export const test = () => describe("chance", function()
{
    describe("create()", function()
    {
        ...
        {
            it("Should call callback immediately if asserted beforehand",
            function()
            {
                const reason = reasonChance.create();
                reason.assert();
            ...
            it("Should call callback immediately if rejected beforehand",
            function()
            {
                const reason = reasonChance.create();
                reason.reject();
