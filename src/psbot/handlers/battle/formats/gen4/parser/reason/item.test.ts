    ...
    describe("item", function () {
        ...
        for (const [name, has] of [
            ...
            describe(`${name}()`, function () {
                describe("#canHold()", function () {
                    it(`Should return ${has} if having the item is the only possibility`, function () {
                        const mon = sh.initActive("p1");
                        mon.item.narrow("pokeball");

                        const reason = reasonItem[name](
                            mon,
                            new Set(["pokeball"]),
                        );
                    ...
                    it("Should return null if possible to have or not have the item", function () {
                        const mon = sh.initActive("p1");
                    ...
                    it(`Should return ${!has} if not possible to have the item`, function () {
                        const mon = sh.initActive("p1");
                ...
                describe("#assert()", function () {
                    it(`Should narrow item and set #canHold()=true`, function () {
                        const mon = sh.initActive("p1");
                        mon.item.narrow("pokeball", "mail");
                        expect(mon.item.possibleValues).to.have.keys(
                            "pokeball",
                            "mail",
                        );
                ...
                describe("#reject()", function () {
                    it(`Should narrow item and set #canHold()=false`, function () {
                        const mon = sh.initActive("p1");
                        mon.item.narrow("pokeball", "mail");
                        expect(mon.item.possibleValues).to.have.keys(
                            "pokeball",
        ...
        describe("hasUnknown()", function () {
            describe("#canHold()", function () {
                ...
                it("Should return null if possible to have or not have an item ", function () {
                    const mon = sh.initActive("p1");
                ...
                it("Should return false if definitely doesn't have an item", function () {
                    const mon = sh.initActive("p1");
