    ...
    describe("interceptSwitch()", function()
    {
        ...
        it("Should handle switch intercept", async function()
        {
            ...
            await ph.handle(
            {
                args:
                [
                    "-activate", toIdent("p1"), toEffectName("pursuit", "move")
                ],
                kwArgs: {}
            });
            await ph.handle(
    ...
    describe("useMove()", function()
    {
        ...
        describe("move event checks", function()
        {
            ...
            it("Should throw if unknown move", async function()
            {
                ...
                {
                    args: ["move", toIdent("p1"), toMoveName("Invalid Move")],
                    kwArgs: {}
                },
                    Error, "Unknown move 'invalidmove'");
            });
            ...
            it("Should throw if unexpected move", async function()
            {
                ...
                await ph.rejectError(
                {
                    ...
                    Error, "Expected move [ember] but got 'watergun'");
            });
            ...
            it("Should throw if expected slp-based move", async function()
            {
                ...
                await ph.rejectError(
                {
                    ...
                    Error, "Expected move [sleeptalk, snore] but got 'ember'");
            });
        });

        /** Handles Splash move for the given pokemon reference. */
        async function moveSplash(side: SideID,
            kwArgs: Event<"|move|">["kwArgs"] = {}, opt = smeargle):
            Promise<void>
        {
            pctx = init(side);
        ...
        async function moveEvent(side: SideID, moveId: string,
            kwArgs: Event<"|move|">["kwArgs"] = {}, opt = smeargle):
            Promise<void>
        {
            await ph.handle(
            {
                args: ["move", toIdent(side, opt), toMoveName(moveId)], kwArgs
            });
        }

        async function moveDamage(side: SideID, hp: number, maxhp = 100,
            kwArgs: Event<"|-damage|">["kwArgs"] = {}, opt = smeargle):
            Promise<void>
        {
            await ph.handle(
            {
                args: ["-damage", toIdent(side, opt), toHPStatus(hp, maxhp)],
                kwArgs
            });
        }
        ...
        describe("setup", function()
        {
            ...
            it("Should not deduct pp if '[from]lockedmove' suffix",
            async function()
            {
                sh.initActive("p1");
                const {moveset, volatile} = sh.initActive("p2");
            ...
            it("Should not deduct pp if releasing two-turn move",
            async function()
            {
                sh.initActive("p2");
            ...
            it("Should not deduct pp if continuing rampage move",
            async function()
            {
                sh.initActive("p2");
                const {moveset, volatile} = sh.initActive("p1");
            ...
            it("Should not deduct pp if continuing momentum move",
            async function()
            {
                sh.initActive("p2");
                const {moveset, volatile} = sh.initActive("p1");
        ...
        describe("fail check", function()
        {
            ...
            it("Should end micleberry status", async function()
            {
                ...
                await ph.handle(
                    {args: ["-notarget", toIdent("p2")], kwArgs: {}});
                await ph.return({});
                expect(mon.volatile.micleberry).to.be.false;
            });
        });

        async function prepareEvent(side: SideID, moveId: string,
            opt = smeargle): Promise<void>
        {
            await ph.handle(
            {
        ...
        describe("two-turn delay check", function()
        {
            ...
            {
                async function animEvent(side1: SideID, moveId: string,
                    side2: SideID, opt1 = smeargle, opt2 = smeargle):
                    Promise<void>
                {
                    await ph.handle(
                    {
                        args:
                        [
                            "-anim", toIdent(side1, opt1), toMoveName(moveId),
                            toIdent(side2, opt2)
                        ],
                        kwArgs: {}
                    });
                ...
                async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p2"), toItemName("powerherb")
                        ],
                        kwArgs: {}
                    });
                    // release in same turn via special |-anim| event
                    ...
                    expect(mon.lastItem.definiteValue).to.equal("powerherb");
                });
                ...
                it("Should throw if monRef mismatch", async function()
                {
                    ...
                    await ph.rejectError(
                    {
                        args: ["-prepare", toIdent("p1"), toMoveName("dive")],
                        kwArgs: {}
                    },
                        Error, "TwoTurn effect 'dive' failed");
                });
                ...
                async function()
                {
                    ...
                    await ph.rejectError(
                    {
                        args: ["-prepare", toIdent("p2"), toMoveName("bounce")],
                        kwArgs: {}
                    },
                        Error,
        ...
        describe("micleberry item implicit effect", function()
        {
            ...
            it("Should end micleberry status after two-turn hit",
            async function()
            {
                sh.initActive("p1").volatile.stall(true);
                const mon = sh.initActive("p2");
        ...
        describe("block checks", function()
        {
            ...
            it("Should handle |-miss| event", async function()
            {
                ...
                await ph.handle(
                {
                    args: ["-miss", toIdent("p2"), toIdent("p1")], kwArgs: {}
                });
                await ph.halt();
                await ph.return({});
            });
        ...
        describe("pre-hit effects", async function()
        {
            describe("on-preHit items (resist berries)", function()
            {
                ...
                {
                    sh.initActive("p1").volatile.changeTypes(["water", "???"]);
                    sh.initActive("p2");
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p1"), toItemName("wacanberry")
                        ],
                        kwArgs: {eat: true}
                    });
                    await ph.handle(
                    ...
                    await ph.handle(
                        {args: ["-supereffective", toIdent("p1")], kwArgs: {}});
        ...
        describe("hit effects", function()
        {
            it("Should handle |-crit| event", async function()
            {
                ...
                await ph.handle({args: ["-crit", toIdent("p1")], kwArgs: {}});
                await moveDamage("p1", 80);
                await ph.halt();
                await ph.return({});
            });
            ...
            describe("type effectiveness assertions", function()
            {
                ...
                {
                    sh.initActive("p1").volatile.changeTypes(["ice", "???"]);
                    sh.initActive("p2");

                    pctx = init("p2");
                    await moveEvent("p2", "icebeam");
                    await ph.handle(
                        {args: ["-resisted", toIdent("p1")], kwArgs: {}});
                ...
                {
                    sh.initActive("p1");
                    sh.initActive("p2").volatile.changeTypes(["rock", "???"]);
            ...
            describe("Substitute", function()
            {
                ...
                it("Should throw if sub-ignoring move doesn't ignore sub",
                async function()
                {
                    pctx = init("p1");
                    await moveEvent("p1", "torment");
                    await ph.rejectError(subBlockedEvent("p2"), Error,
                ...
                async function()
                {
                    ...
                    await ph.rejectError(
                        {
                            args: ["-damage", toIdent("p2"), toHPStatus(80)],
                            kwArgs: {}
                        },
                        Error,
        ...
        describe("post-hit effects", function()
        {
            describe("damage", function()
            {
                ...
                it("Should handle split-damage effect (painsplit)",
                async function()
                {
                    sh.initActive("p1");
                    sh.initActive("p2").hp.set(50);
            ...
            describe("countable status", function()
            {
                it("Should handle perishsong", async function()
                {
                    ...
                    {
                        args:
                            ["-start", toIdent("p1"), toEffectName("perish3")],
                        kwArgs: {silent: true}
                    });
                    await ph.handle(
                    {
                        args:
                            ["-start", toIdent("p2"), toEffectName("perish3")],
                        kwArgs: {silent: true}
                    });
                    await ph.handle(
                    {
                        args:
                        [
                            "-fieldactivate", toEffectName("perishsong", "move")
                        ],
                        kwArgs: {}
                    });
                    await ph.halt();
            ...
            describe("boost", function()
            {
                ...
                function shouldHandleBoost(ctg: "self" | "hit", move: string,
                    stat: dex.BoostName, posBoost: boolean, amount: number,
                    abilityImmunity?: string,
                    immunityHolder?: SwitchOptions): void
                {
                    ...
                    boostTests[ctg].push(function()
                    {
                        ...
                        it("Should throw if reject before effect",
                        async function()
                        {
                            sh.initActive("p1");
                            sh.initActive("p2");
                        ...
                        async function()
                        {
                            sh.initActive("p1");
                            sh.initActive("p2");
                            state.getTeam(target).active.volatile.boosts[stat] =
                                6 * Math.sign(amount);
                        ...
                        it("Should allow boost message with amount=0 if " +
                            "maxed out",
                        async function()
                        {
                            sh.initActive("p1");
                        ...
                        async function()
                        {
                            ...
                            await ph.handle(
                            {
                                args:
                                [
                                    "-fail", toIdent(target), "unboost",
                                    stat
                                ],
                                kwArgs:
                                {
                                    from: toEffectName(abilityImmunity,
                                        "ability"),
                                    of: toIdent(target)
                                }
                            });
                        ...
                        it(`Should throw if ${abilityImmunity} didn't ` +
                            "activate when it's known",
                        async function()
                        {
                            sh.initActive("p1");
                            sh.initActive("p2").setAbility(abilityImmunity);
                ...
                boostTests.self.push(() => describe("set-boost", function()
                {
                    it("Should handle set boost", async function()
                    {
                        ...
                        await ph.handle(
                        {
                            args: ["-setboost", toIdent("p1"), "atk", toNum(6)],
                            kwArgs: {}
                        });
                        await ph.halt();
                        await ph.return({});
                    ...
                    it("Should activate berry from bellydrum", async function()
                    {
                        ...
                        await ph.handle(
                        {
                            args: ["-heal", toIdent("p1"), toHPStatus(75)],
                ...
                function shouldHandlePartialBoost(ctg: "self" | "hit",
                    move: string, stat: dex.BoostName, amount: 2 | -2): void
                {
                ...
                function shouldHandleSecondaryBoost(ctg: "self" | "hit",
                    move: string, stat: dex.BoostName, posBoost: boolean,
                    amount: number): void
                {
                    boostTests[ctg].push(function()
                    {
                        it("Should handle boost via secondary effect using " +
                            move, async function()
                        {
                            const target = ctg === "self" ? "p1" : "p2";
                            sh.initActive("p1");
                        ...
                        it("Shouldn't throw if no secondary boost using " +
                            move, async function()
                        {
                            sh.initActive("p1");
                            sh.initActive("p2");
                    ...
                    move: string, stat: dex.BoostName, amount: number): void
                {
                    ...
                    boostTests[ctg].push(function()
                    {
                        ...
                        it("Should allow no boost event for 100% secondary " +
                            "effect if maxed out", async function()
                        {
                            let mon = sh.initActive("p1");
                            if (target === "p2") mon = sh.initActive("p2");
                            mon.volatile.boosts[stat] = sign * 6;
                ...
                boostTests.self.push(() => describe("Curse (non-ghost)",
                function()
                {
            ...
            describe("status", function()
            {
                ...
                function testNonRemovable(
                    {
                        ctg, name, moveId, preEvents, startEvent,
                ...
                function testRemovable(
                    {
                        ctg, name, effect, moveId, startEvent, endEvent,
                        secondaryMove, secondaryMove100, abilityImmunity,
                        clauseEvent
                    }: TestRemovableArgs): void
                {
                    ...
                    statusTests[ctg].push(() => describe(name, function()
                    {
                        ...
                        it("Should still pass if end event on an unrelated" +
                            "move",
                        async function()
                        {
                        ...
                        if (secondaryMove100)
                        {
                            ...
                            async function()
                            {
                                const mon = state.getTeam(target).active;
                                if (dex.isMajorStatus(effect))
                                {
                        ...
                        {
                            it("Should narrow ability if no status event due " +
                                "to silent ability immunity",
                            async function()
                            {
                        ...
                        {
                            it("Should be blocked by clause",
                            async function()
                            {
                                pctx = init("p2");
                                await moveEvent("p2", moveId);
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "aquaring", moveId: "aquaring",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "attract", moveId: "attract",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "charge", moveId: "charge",
                    preEvents:
                    [{
                        args: ["-boost", toIdent("p2"), "spd", toNum(1)],
                        kwArgs: {}
                    }],
                    startEvent:
                    {
                ...
                statusTests.hit.push(() => describe("curse (ghost)", function()
                {
                    ...
                    {
                        sh.initActive("p1");
                        sh.initActive("p2", smeargle).volatile.addedType =
                            "ghost";
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "embargo", moveId: "embargo",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "encore", moveId: "encore",
                    startEvent:
                    {
                        args:
                        [
                ...
                statusTests.hit.push(() => describe("Flash Fire", function()
                {
                    ...
                    it("Should block move effects", async function()
                    {
                        ...
                        await ph.handle(
                        {
                            ...
                            kwArgs: {from: toEffectName("flashfire", "ability")}
                        });
                        await ph.halt();
                        await ph.return({});
                    });
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "focusenergy", moveId: "focusenergy",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "foresight", moveId: "foresight",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "healblock", moveId: "healblock",
                    startEvent:
                    {
                        args:
                        [
                ...
                statusTests.self.push(() => describe("imprison", function()
                {
                    ...
                    {
                        species: "vulpix", level: 10, gender: "M", hp: 100,
                        hpMax: 100
                    };
                    const themBulbasaur: SwitchOptions =
                    {
                        species: "bulbasaur", level: 10, gender: "M", hp: 100,
                        hpMax: 100
                    };

                    function setup(imprisonUser: SideID, sameOpponent = true):
                        void
                    {
                        us = sh.initActive("p1", usVulpix);
                        us.moveset.reveal(
                            imprisonUser === "p1" ? "imprison" : "protect");
                    ...
                    describe("Failed", function()
                    {
                        ...
                        it("Should throw if shared moves", async function()
                        {
                            ...
                            await ph.rejectError(
                            {
                                args: ["-fail", toIdent("p2", themVulpix)],
                                kwArgs: {}
                            },
                                Error,
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "ingrain", moveId: "ingrain",
                    startEvent:
                    {
                        args:
                        [
                ...
                testRemovable(
                {
                    ctg: "hit", name: "leechseed", effect: "leechseed",
                    moveId: "leechseed",
                    startEvent:
                    {
                        args:
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "magnetrise", moveId: "magnetrise",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "miracleeye", moveId: "miracleeye",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "mudsport", moveId: "mudsport",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "nightmare", moveId: "nightmare",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "powertrick", moveId: "powertrick",
                    startEvent:
                    {
                        args:
                        [
                ...
                {
                    const target = ctg === "self" ? "p2" : "p1";
                    statusTests[ctg].push(() => describe("slowstart", function()
                    {
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "Substitute", moveId: "substitute",
                    startEvent:
                    {
                        args:
                        [
                    ...
                    postEvents:
                    [{
                        args: ["-damage", toIdent("p2"), toHPStatus(75)],
                        kwArgs: {}
                    }]
                });
                testNonRemovable(
                {
                    ctg: "hit", name: "suppressAbility", moveId: "gastroacid",
                    startEvent:
                        {args: ["-endability", toIdent("p1")], kwArgs: {}}
                });
                testNonRemovable(
                {
                    ctg: "hit", name: "Taunt", moveId: "taunt",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "hit", name: "torment", moveId: "torment",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "watersport", moveId: "watersport",
                    startEvent:
                    {
                        args:
                        [
                ...
                testRemovable(
                {
                    ...
                    startEvent:
                    {
                        args:
                        [
                            "-start", toIdent("p1"), toEffectName("confusion")
                        ],
                        kwArgs: {}
                    },
                    endEvent:
                    {
                        args:
                            ["-end", toIdent("p1"), toEffectName("confusion")],
                        kwArgs: {}
                    },
                    secondaryMove: "psybeam", secondaryMove100: "dynamicpunch",
                    abilityImmunity: "owntempo"
                });
                testNonRemovable(
                {
                    ctg: "self", name: "bide", moveId: "bide",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "uproar", moveId: "uproar",
                    startEvent:
                    {
                        args:
                        [
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "grudge", moveId: "grudge",
                    startEvent:
                    {
                        args:
                        [
                            "-singlemove", toIdent("p2"), toMoveName("grudge")
                        ],
                        kwArgs: {}
                    }
                });
                testNonRemovable(
                {
                    ctg: "self", name: "rage", moveId: "rage",
                    startEvent:
                    {
                        args:
                            ["-singlemove", toIdent("p2"), toMoveName("rage")],
                        kwArgs: {}
                    }
                });
                ...
                testNonRemovable(
                {
                    ...
                    startEvent:
                    {
                        args:
                        [
                            "-singleturn", toIdent("p2"), toMoveName("endure")
                        ],
                        kwArgs: {}
                    }
                });
                testNonRemovable(
                {
                    ctg: "self", name: "magiccoat", moveId: "magiccoat",
                    startEvent:
                    {
                        args:
                        [
                            "-singleturn", toIdent("p2"),
                ...
                testNonRemovable(
                {
                    ctg: "self", name: "protect", moveId: "protect",
                    startEvent:
                    {
                        args:
                        [
                            "-singleturn", toIdent("p2"), toMoveName("protect")
                        ],
                        kwArgs: {}
                    }
                });
                testNonRemovable(
                {
                    ctg: "self", name: "roost", moveId: "roost",
                    preEvents:
                    [{
                        args: ["-heal", toIdent("p2"), toHPStatus(100)],
                        kwArgs: {}
                    ...
                    {
                        args:
                            ["-singleturn", toIdent("p2"), toMoveName("roost")],
                        kwArgs: {}
                    }
                });
                testNonRemovable(
                {
                    ctg: "self", name: "snatch", moveId: "snatch",
                    startEvent:
                    {
                        args:
                        [
                            "-singleturn", toIdent("p2"), toMoveName("snatch")
                        ],
                        kwArgs: {}
                    }
                });
                ...
                testRemovable(
                {
                    ...
                    endEvent:
                    {
                        args: ["-curestatus", toIdent("p1"), "brn"], kwArgs: {}
                    },
                    secondaryMove: "flamethrower", abilityImmunity: "waterveil"
                });
                testRemovable(
                {
                    ctg: "hit", name: "frz", effect: "frz",
                    startEvent:
                        {args: ["-status", toIdent("p1"), "frz"], kwArgs: {}},
                    endEvent:
                    {
                        args: ["-curestatus", toIdent("p1"), "frz"], kwArgs: {}
                    },
                    secondaryMove: "icebeam", abilityImmunity: "magmaarmor"
                });
                testRemovable(
                {
                    ctg: "hit", name: "par", effect: "par", moveId: "stunspore",
                    startEvent:
                        {args: ["-status", toIdent("p1"), "par"], kwArgs: {}},
                    endEvent:
                    {
                        args: ["-curestatus", toIdent("p1"), "par"], kwArgs: {}
                    },
                ...
                testRemovable(
                {
                    ctg: "hit", name: "psn", effect: "psn",
                    moveId: "poisonpowder",
                    startEvent:
                        {args: ["-status", toIdent("p1"), "psn"], kwArgs: {}},
                    endEvent:
                    {
                        args: ["-curestatus", toIdent("p1"), "psn"], kwArgs: {}
                    },
                    secondaryMove: "gunkshot", abilityImmunity: "immunity"
                });
                testRemovable(
                {
                    ctg: "hit", name: "slp", effect: "slp", moveId: "spore",
                    startEvent:
                        {args: ["-status", toIdent("p1"), "slp"], kwArgs: {}},
                    endEvent:
                    {
                    ...
                    clauseEvent:
                    {
                        args:
                        [
                            "-message", toMessage("Sleep Clause activated.")
                        ],
                        kwArgs: {}
                    }
                });
                testRemovable(
                {
                    ctg: "hit", name: "tox", effect: "tox", moveId: "toxic",
                    startEvent:
                ...
                function()
                {
                    it("Should handle ability status immunity while leaving " +
                        "other move effects intact", async function()
                    {
                        sh.initActive("p1");
                        ...
                        await ph.handle(
                        {
                            args: ["-immune", toIdent("p2"), "confusion"],
                            kwArgs: {from: toEffectName("owntempo", "ability")}
                        });
                        await ph.halt();
                        await ph.return({});
                    });
            ...
            describe("item on-super (enigmaberry)", function()
            {
                it("Should handle enigmaberry", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p1"), toItemName("enigmaberry")
                        ],
                        kwArgs: {eat: true}
                    });
                    await ph.handle(
            ...
            describe("ability on-moveDamage (colorchange)", function()
            {
                it("Should handle ability", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-start", toIdent("p2"), toEffectName("typechange"),
                            toTypes("water")
                        ],
            ...
            describe("item on-postHit (jabocaberry/rowapberry)", function()
            {
                it("Should handle jabocaberry (physical)", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p1"), toItemName("jabocaberry")
                        ],
                        kwArgs: {eat: true}
                    });
                    await moveDamage("p2", 50, 100,
                ...
                it("Should handle rowapberry (special)", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p1"), toItemName("rowapberry")
                        ],
                        kwArgs: {eat: true}
                    });
                    await moveDamage("p2", 50, 100,
            ...
            describe("item on-update", function()
            {
                it("Should handle", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-enditem", toIdent("p1"), toItemName("sitrusberry")
                        ],
                        kwArgs: {eat: true}
                    });
                    await ph.handle(
        ...
        describe("multi-hit effect", function()
        {
            it("Should handle multi-hit move", async function()
            {
                ...
                await moveDamage("p2", 50);
                await ph.handle(
                    {args: ["-hitcount", toIdent("p2"), toNum(2)], kwArgs: {}});
                await ph.halt();
                await ph.return({});
            });

            it("Should throw if invalid |-hitcount| event ident",
            async function()
            {
                sh.initActive("p1");
                sh.initActive("p2");
                ...
                await moveDamage("p1", 50);
                await ph.rejectError(
                    {args: ["-hitcount", toIdent("p2"), toNum(1)], kwArgs: {}},
                    Error,
                    "Invalid |-hitcount| event: Expected non-p2 but got p2");
            });

            it("Should throw if invalid |-hitcount| event count",
            async function()
            {
                sh.initActive("p1");
                sh.initActive("p2");
                ...
                await moveDamage("p1", 50);
                await ph.rejectError(
                    {args: ["-hitcount", toIdent("p1"), toNum(2)], kwArgs: {}},
                    Error, "Invalid |-hitcount| event: Expected 1 but got '2'");
            });
        ...
        describe("other effects", function()
        {
            describe("swap-boosts", function()
            {
                ...
                it("Should handle swap boost move", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args:
                        [
                            "-swapboost", toIdent("p2"), toIdent("p1"),
                            toBoostIDs("def", "spd")
                        ],
                ...
                it("Should throw if event doesn't include user",
                async function()
                {
                    pctx = init("p2");
                    ...
                    await ph.rejectError(
                    {
                        args:
                        [
                            "-swapboost", toIdent("p1"), toIdent("p1"),
                            toBoostIDs("atk", "spa")
                        ],
                        kwArgs: {from: toEffectName("powerswap", "move")}
                    },
                        Error,
                        "Expected effect that didn't happen: " +
            ...
            describe("team", function()
            {
                ...
                {
                    teamTests.self.push(() => describe(effect, function()
                    {
                        ...
                        it("Should reject if mismatch", async function()
                        {
                            ...
                            pctx = init("p2")
                            await moveEvent("p2", move);
                            const otherName = effect === "reflect" ?
                ...
                {
                    teamTests.hit.push(() => describe(effect, function()
                    {
                        it("Should pass if expected", async function()
                        {
                            sh.initActive("p1");
                        ...
                        if (move === "spikes") // ground move
                        {
                            ...
                            async function()
                            {
                                sh.initActive("p1").setAbility("levitate");
                                sh.initActive("p2");
            ...
            describe("field", function()
            {
                it("Should pass if expected", async function()
                {
                    ...
                    await ph.handle(
                    {
                        args: ["-fieldstart", "Trick Room" as FieldCondition],
                        kwArgs: {}
                    });
                    await ph.halt();
                    await ph.return({});
                ...
                {
                    it("Should infer source via move and infer weather item " +
                        "if it goes too long",
                    async function()
                    {
                        sh.initActive("p1")
                    ...
                    it("Should reject if mismatch", async function()
                    {
                        ...
                        await moveEvent("p2", "raindance");
                        await ph.rejectError(
                            {args: ["-weather", "Hail" as Weather], kwArgs: {}},
                            Error,
                            "Expected effect that didn't happen: " +
        ...
        describe("implicit effects", function()
        {
            ...
            describe("status", function()
            {
                function testImplicitStatusEffect(name: string, move: string,
                    event: Event, getter: (mon: ReadonlyPokemon) => boolean):
                    void
                {
                    describe(name, function()
                    {
                ...
                testImplicitStatusEffect("defensecurl", "defensecurl",
                    {
                        args: ["-boost", toIdent("p1"), "def", toNum(1)],
                        kwArgs: {}
                    },
                ...
                testImplicitStatusEffect("mustRecharge", "hyperbeam",
                    {
                    ...
                    resetOnMiss?: boolean): void
                {
                    describe(name,
                        () => keys.forEach(move => describe(move, function()
                        {
                            ...
                            it(`Should ${resetOnMiss ? "" : "not "}reset if ` +
                                "missed",
                            async function()
                            {
                            ...
                            async function()
                            {
                                ...
                                const m = state.getTeam("p2").active.moveset
                                    .get(move)!;
                    ...
                    describe(effect, function()
                    {
                        ...
                        async function()
                        {
                            ...
                            await ph.handle(
                            {
                                args:
                                [
                                    "switch", toIdent("p2", ditto),
                                    toDetails(ditto), toHPStatus(100)
                                ],
                                kwArgs: {}
                            });
                            ...
                            await ph.handle(
                            {
                                args:
                                [
                                    "-heal", toIdent("p2", ditto),
                                    toHPStatus(100, 100)
                                ],
                                kwArgs: {from: toEffectName(effect, "move")}
                            });
                            await ph.halt();
                            await ph.return({});
                        });
        ...
        describe("final effects", function()
        {
            describe("recoil", function()
            {
                    ...
                    recoilEvent: boolean, infer?: boolean | "throw"): void
                {
                    it(name, async function()
                    {
                        ...
                        {
                            await ph.haltError(Error,
                                "Move doubleedge user 'p1' suppressed recoil " +
                                    "through an ability but ability is " +
                                    "suppressed");
                            return;
                        }
                        if (!recoilEvent)
                ...
                it("Should handle Struggle move recoil ignoring " +
                    "recoil-blocking abilities", async function()
                {
            ...
            describe("on-movePostDamage items (lifeorb)", function()
            {
                ...
                it("Should reject if inappropriate move", async function()
                {
                    ...
                    await ph.reject(
                    {
                        args:
                        [
                            "-damage", toIdent("p1"), toHPStatus(90)
                        ],
            ...
            describe("transform", function()
            {
                ...
                it("Should reject if user/source mismatch", async function()
                {
                    ...
                    await ph.rejectError(
                    {
                        args: ["-transform", toIdent("p1"), toIdent("p2")],
                        kwArgs: {}
                    },
                        Error,
            ...
            describe("self-switch", function()
            {
                ...
                it("Should accept if self-switch expected", async function()
                {
                    ...
                    await ph.handle(
                    {
                        ...
                        [
                            "request",
                            toRequestJSON(
                                {requestType: "wait", rqid: 0, side: undefined})
                        ],
                        kwArgs: {}
                    });
                    await ph.handle(
                ...
                it("Should cancel effect if game-over", async function()
                {
                    ...
                    await ph.reject(
                    {
                        args: ["win", toUsername(state.username)], kwArgs: {}
                    });
                    await ph.return({});
                });
                ...
                it("Should throw if self-switch expected but opponent switched",
                async function()
                {
                    sh.initActive("p1");
                    sh.initActive("p2");
            ...
            describe("call", function()
            {
                ...
                describe("mirrormove effect", function()
                {
                    ...
                    it("Should track only on two-turn release turn",
                    async function()
                    {
                        const us = sh.initActive("p1");
                        sh.initActive("p2");
                    ...
                    it("Should still track on called two-turn release turn",
                    async function()
                    {
                        const us = sh.initActive("p1");
                        sh.initActive("p2");
                        ...
                        await moveEvent("p2", "fly",
                            {from: toMoveName(otherCallers[0]), still: true});
                        await prepareEvent("p2", "fly");
                        await ph.halt();
                        await ph.return({});
                        expect(us.volatile.mirrormove).to.equal("previous");
                    ...
                    it("Should not track if move can't be mirrored",
                    async function()
                    {
                        const us = sh.initActive("p1");
                        sh.initActive("p2");
                ...
                describe("self move-callers (sleeptalk)", function()
                {
                    ...
                    async function()
                    {
                        ...
                        await ph.rejectError(
                        {
                            args:
                            [
                                "move", toIdent("p1"), toMoveName("tackle")
                            ],
                            kwArgs: {from: toMoveName(selfMoveCallers[0])}
                        },
                            Error,
                            "Call effect 'self' failed: Expected 'p2' but " +
                                "got 'p1'");
                ...
                describe("target move-callers (mefirst)", function()
                {
                    ...
                    async function()
                    {
                        ...
                        {
                            args: ["move", toIdent("p1"), toMoveName("tackle")],
                            kwArgs: {from: toMoveName(targetMoveCallers[0])}
                        },
                            Error,
