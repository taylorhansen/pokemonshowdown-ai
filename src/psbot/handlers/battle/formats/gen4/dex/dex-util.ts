...
export type StatusType = UpdatableStatusType | SingleMoveType |
    SingleTurnType | MajorStatus | SplashType | "aquaring" | "attract" |
    "charge" | "curse" | "embargo" | "encore" | "flashfire" | "focusenergy" |
    "foresight" | "healblock" | "imprison" | "ingrain" | "leechseed" |
    "magnetrise" | "miracleeye" | "mudsport" | "nightmare" | "powertrick" |
    "slowstart" | "substitute" | "suppressAbility" | "taunt" | "torment" |
    "watersport" | "yawn";
...
export interface ItemData extends DexData
{
    ...
    readonly on?:
    {
        ...
        } |
        {
            ...
            /**
             * Whether to cure the status. Only applicable for non-berry items
             * which don't use the on-`eat` effect.
             */
            readonly cure?: true;
            /** Whether to consume item. */
            readonly consume?: true;
        ...
        {
            /**
             * Effect restores PP to a move, either the first slot with 0PP or
             * the first slot with less than max.
             */
