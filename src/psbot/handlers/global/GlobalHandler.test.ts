...
export const test = () => describe("GlobalHandler", function()
{
    ...
    describe("|popup|", function()
    {
        it("Should do nothing", function()
        {
            gh.handle({args: ["popup", "msg" as Protocol.Message], kwArgs: {}});
        });
    });
    ...
    describe("|usercount|", function()
    {
        it("Should do nothing", function()
        {
            gh.handle({args: ["usercount", "1" as Protocol.Num], kwArgs: {}});
        });
    });
    ...
    describe("|challstr|", function()
    {
        ...
        it("Should throw if 2 challstrs received", async function()
        {
            ...
            expect(() => gh.handle({args: ["challstr", "y"], kwArgs: {}}))
    ...
    describe("|formats|", function()
    {
        it("Should do nothing", function()
        {
            gh.handle(
            {
                args: ["formats", "gen4randombattle,#" as Protocol.FormatsList],
                kwArgs: {}
            });
        });
    });
