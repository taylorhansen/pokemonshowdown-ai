...
import { GameWorkerData, GameMessage, GamePlay, GamePlayResult } from
    "./GameProtocol";
...
async function processMessage(msg: GamePlay):
...
const gameStream = new stream.Transform(
{
    ...
    transform(msg: GamePlay, encoding: BufferEncoding,
