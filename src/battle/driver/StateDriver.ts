...
/**
 * Ensures that the StateDriver implements handlers for each type of
 * DriverEvent.
 */
...
export class StateDriver implements DriverEventHandler
{
    ...
    public getChoices(switchOnly = false): Choice[]
    {
        ...
        if (!switchOnly)
        {
            if (mon.volatile.lockedMove.isActive) return ["move 1"];
