...
/** Args for {@link setMultiHeadAttention}. */
export interface SetMultiHeadAttentionArgs extends LayerArgs {
    /** Number of heads. */
    heads: number;
...
class SetMultiHeadAttention extends tf.layers.Layer {
    public static className = "SetMultiHeadAttention";
    ...
    public constructor(args: SetMultiHeadAttentionArgs) {
        super(args);
    ...
    public override call(
        ...
        return tf.tidy(() => {
            ...
            let attn = attention(
                ...
                keys,
                values,
                tf.reciprocal(tf.sqrt(inputFeatures)).asScalar(),
                mask,
                mask,
            );
...
tf.serialization.registerClass(SetMultiHeadAttention);
 ...
 * {@link SetMultiHeadAttentionArgs.units units} argument, containing the
 * aggregated multi-head attention output for each element in the input set.
 */
export function setMultiHeadAttention(args: SetMultiHeadAttentionArgs) {
    return new SetMultiHeadAttention(args);
}
